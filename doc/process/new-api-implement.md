...
## Prompt Example
```text
#file:orders.yaml に定義されている注文作成APIを作成してください。関連するユーザーストーリーは #file:US-003_カート管理と注文確定.md です。
```
...
- [ ] `backend/AGENTS.md`に記載されているルールに準拠したTaskになっている
...
2. 作成したソースコードが `backend/AGENTS.md` に記載されているコーディング規約に沿っていることを確認する
...
- [ ] `backend/AGENTS.md`に記載してあるルールに沿った実装になっている
